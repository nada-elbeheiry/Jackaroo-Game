...
public class Board  implements BoardManager,BoardListener {
    ...
    public int getPositionInPathhelp(ArrayList<Cell> path, Marble marble){
    	return getPositionInPath(path,marble);
    }
    ...
    private void move(Marble marble, ArrayList<Cell> fullPath, boolean destroy) throws IllegalDestroyException {
    	...
    	if(boardListener!=null){
    		onMove(getPositionInPath(track,currentCell.getMarble()),getPositionInPath(track,targetCell.getMarble()));
    	}
